...
|-- plantillas/
|   |-- Agent_Canvas_Template.md       # Editable template in Markdown
|   |-- canvas_cloud.html              # Interactive Canvas - Cloud Edition
|   |-- canvas_onprem.html             # Interactive Canvas - On-Prem Edition
|-- docs/
|   |-- best-practices-guide.md        # Complete best practices guide
|   |-- working-order.md               # Suggested order for filling in the canvas
|-- ejemplos/
|   |-- example-it-support-agent.md   # Example: IT support agent
|   |-- example-onboarding-agent.md   # Example: onboarding agent
```
...
1. **Choose your format** from the `plantillas/` folder
...
5. Read the [best practices guide](docs/best-practices-guide.md) to bring your agent to production
...
The framework is platform-agnostic, but includes specific guidance for:

- **Microsoft Copilot Studio + Power Platform** — Microsoft 365 environments with corporate governance
- **LangChain / LangGraph** — technical teams who need full control
- **Any stack** — the design principles apply regardless of technology
...
- Share examples of agents designed with the canvas
- Translate the framework into other languages
- Propose improvements to the blocks or workflow
